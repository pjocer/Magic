...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        UIView *block_1 = [[UIView alloc]initWithFrame:CGRectMake(0.0f,
                                                                  0.0f,
                                                                  self.width,
                                                                  self.width)];
        ...
        UIView *block_2 = [[UIView alloc]initWithFrame:CGRectMake(0.0f,
                                                                  block_1.bottom + self.width/2.0f,
                                                                  self.width,
                                                                  self.width)];
        block_2.backgroundColor = Global_trelloLightGray;
        [self addSubview:block_2];
        
        UIView *block_3 = [[UIView alloc]initWithFrame:CGRectMake(0.0f,
                                                                  block_2.bottom + self.width/2.0f,
                                                                  self.width,
                                                                  self.width)];
